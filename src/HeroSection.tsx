  ...
  return (
    <>
      <div className="flex flex-wrap min-h-24 items-center justify-center w-full bg-slate-300">
        ...
        <img className="max-w-1/2 h-auto basis-auto grow shrink" src="./public/camping-3.jpg" alt="A man climbing a mountain."></img>
        
        <img className="max-w-1/2 h-auto basis-auto grow shrink" src="./public/camping-2.jpg" alt="Some hiking gear sitting on a stone near a creek bed."></img>
      </div>
